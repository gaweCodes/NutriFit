...
public class MenuPlan : Entity<MenuPlanId>, IAggregateRoot
{
    ...
    private MenuPlan() { }
    private MenuPlan(DateOnly startDate, DateOnly endDate, IUniqueMenuPlanDateRangeChecker? uniqueMenuPlanDateRangeChecker = null)
    {
