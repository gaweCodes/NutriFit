...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MealSlotRecipes", b =>
                {
                    ...
                    b.HasKey("MealSlotId", "RecipeId");

                    b.HasIndex("RecipeId");

                    b.ToTable("MealSlotRecipes", (string)null);
                });

            modelBuilder.Entity("Nutrition.Domain.MenuPlans.DayPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Nutrition.Domain.MenuPlans.MealSlot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MealSlotRecipes", b =>
                {
                    b.HasOne("Nutrition.Domain.MenuPlans.MealSlot", null)
                        .WithMany()
                        .HasForeignKey("MealSlotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Nutrition.Domain.Recipes.Recipe", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Nutrition.Domain.MenuPlans.DayPlan", b =>
                {
                    b.HasOne("Nutrition.Domain.MenuPlans.MenuPlan", null)
                        .WithMany("Days")
            ...
            modelBuilder.Entity("Nutrition.Domain.MenuPlans.MealSlot", b =>
                {
                    b.HasOne("Nutrition.Domain.MenuPlans.DayPlan", null)
                        .WithMany("MealSlots")
